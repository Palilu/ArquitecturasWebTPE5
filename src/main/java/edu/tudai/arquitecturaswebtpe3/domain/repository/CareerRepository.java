...
public interface CareerRepository extends JpaRepository<Career, Long> {
     ...
     */
    @Query(" SELECT new edu.tudai.arquitecturaswebtpe3.domain.dto.CareerCount(c.id, c.name, count(i)) " +
     ...
     */
    @Query(" SELECT new edu.tudai.arquitecturaswebtpe3.domain.dto.CareerReportRow(" +
           "     c.id, " +
           "     c.name, " +
           "     YEAR(i.since), " +
